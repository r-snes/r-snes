...
const INSTR_CYC1: [InstrCycle; 256] = [
    ...
    /* 6b */ InstrCycle(todo_opcode!(0x6b)),
    ...
    /* 74 */ InstrCycle(todo_opcode!(0x74)),
    ...
    /* 81 */ InstrCycle(todo_opcode!(0x81)),
    /* 82 */ InstrCycle(todo_opcode!(0x82)),
    /* 83 */ InstrCycle(todo_opcode!(0x83)),
    /* 84 */ InstrCycle(todo_opcode!(0x84)),
    /* 85 */ InstrCycle(todo_opcode!(0x85)),
    /* 86 */ InstrCycle(todo_opcode!(0x86)),
    /* 87 */ InstrCycle(todo_opcode!(0x87)),
    /* 88 */ InstrCycle(todo_opcode!(0x88)),
    /* 89 */ InstrCycle(todo_opcode!(0x89)),
    /* 8a */ InstrCycle(todo_opcode!(0x8a)),
    /* 8b */ InstrCycle(todo_opcode!(0x8b)),
    /* 8c */ InstrCycle(todo_opcode!(0x8c)),
    /* 8d */ InstrCycle(todo_opcode!(0x8d)),
    /* 8e */ InstrCycle(todo_opcode!(0x8e)),
    /* 8f */ InstrCycle(todo_opcode!(0x8f)),
    /* 90 */ InstrCycle(todo_opcode!(0x90)),
    /* 91 */ InstrCycle(todo_opcode!(0x91)),
    /* 92 */ InstrCycle(todo_opcode!(0x92)),
    /* 93 */ InstrCycle(todo_opcode!(0x93)),
    /* 94 */ InstrCycle(todo_opcode!(0x94)),
    /* 95 */ InstrCycle(todo_opcode!(0x95)),
    /* 96 */ InstrCycle(todo_opcode!(0x96)),
    /* 97 */ InstrCycle(todo_opcode!(0x97)),
    /* 98 */ InstrCycle(todo_opcode!(0x98)),
    /* 99 */ InstrCycle(todo_opcode!(0x99)),
    /* 9a */ InstrCycle(todo_opcode!(0x9a)),
    /* 9b */ InstrCycle(todo_opcode!(0x9b)),
    /* 9c */ InstrCycle(todo_opcode!(0x9c)),
    /* 9d */ InstrCycle(todo_opcode!(0x9d)),
    /* 9e */ InstrCycle(todo_opcode!(0x9e)),
    /* 9f */ InstrCycle(todo_opcode!(0x9f)),
    /* a0 */ InstrCycle(todo_opcode!(0xa0)),
    /* a1 */ InstrCycle(todo_opcode!(0xa1)),
    /* a2 */ InstrCycle(todo_opcode!(0xa2)),
    /* a3 */ InstrCycle(todo_opcode!(0xa3)),
    /* a4 */ InstrCycle(todo_opcode!(0xa4)),
    /* a5 */ InstrCycle(todo_opcode!(0xa5)),
    /* a6 */ InstrCycle(todo_opcode!(0xa6)),
    /* a7 */ InstrCycle(todo_opcode!(0xa7)),
    /* a8 */ InstrCycle(todo_opcode!(0xa8)),
    /* a9 */ InstrCycle(todo_opcode!(0xa9)),
    /* aa */ InstrCycle(todo_opcode!(0xaa)),
    /* ab */ InstrCycle(todo_opcode!(0xab)),
    /* ac */ InstrCycle(todo_opcode!(0xac)),
    /* ad */ InstrCycle(todo_opcode!(0xad)),
    /* ae */ InstrCycle(todo_opcode!(0xae)),
    /* af */ InstrCycle(todo_opcode!(0xaf)),
    /* b0 */ InstrCycle(todo_opcode!(0xb0)),
    /* b1 */ InstrCycle(todo_opcode!(0xb1)),
    /* b2 */ InstrCycle(todo_opcode!(0xb2)),
    /* b3 */ InstrCycle(todo_opcode!(0xb3)),
    /* b4 */ InstrCycle(todo_opcode!(0xb4)),
    /* b5 */ InstrCycle(todo_opcode!(0xb5)),
    /* b6 */ InstrCycle(todo_opcode!(0xb6)),
    /* b7 */ InstrCycle(todo_opcode!(0xb7)),
    /* b8 */ InstrCycle(clv_cyc1),
    /* b9 */ InstrCycle(todo_opcode!(0xb9)),
    /* ba */ InstrCycle(todo_opcode!(0xba)),
    /* bb */ InstrCycle(todo_opcode!(0xbb)),
    /* bc */ InstrCycle(todo_opcode!(0xbc)),
    /* bd */ InstrCycle(todo_opcode!(0xbd)),
    /* be */ InstrCycle(todo_opcode!(0xbe)),
    /* bf */ InstrCycle(todo_opcode!(0xbf)),

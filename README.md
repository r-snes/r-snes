...
> [!NOTE]
> For now, this is still a work in progress. We successfully run and pass the full [test ROM](https://github.com/gilyon/snes-tests) suite, but we're still some way from running actual commercial games.
